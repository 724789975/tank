...
REM  - Output : build_android/pongpongpong.apk (cleaned before build)
...
REM Output dir and APK file (name follows Player Settings productName)
set "OUTPUT_DIR=%~dp0"
set "OUTPUT_PATH=%OUTPUT_DIR%pongpongpong.apk"
set "LOG_FILE=%OUTPUT_DIR%build_ws.log"
set "EXIT_FILE=%OUTPUT_DIR%build_ws.exitcode"
set "BUILD_NAME=Android Client (WebSocketSharp)"
