...
REM ============================================================
REM  Unity Linux AI Bot build script (FxNet)
...
REM  - Output : build_lai/tank.x86_64 (cleaned before build)
REM ============================================================
...
set "BUILD_NAME=Linux AI Bot (FxNet)"
...
"%UNITY_PATH%" -quit -batchmode -nographics ^
    ...
    -buildTarget Linux64 ^
    -executeMethod ServerBuild.BuildLinuxAI ^
