...
import (
	...
	user_center_service "route_module/kitex_gen/user_center_service"
)
...
func googleLoginHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(user_center.GoogleLoginReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
...
type GoogleLoginArgs struct {
	Req *user_center.GoogleLoginReq
}
...
func (p *GoogleLoginArgs) Unmarshal(in []byte) error {
	msg := new(user_center.GoogleLoginReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GoogleLoginArgs_Req_DEFAULT *user_center.GoogleLoginReq

func (p *GoogleLoginArgs) GetReq() *user_center.GoogleLoginReq {
	if !p.IsSetReq() {
...
type GoogleLoginResult struct {
	Success *user_center.GoogleLoginRsp
}

var GoogleLoginResult_Success_DEFAULT *user_center.GoogleLoginRsp
...
func (p *GoogleLoginResult) Unmarshal(in []byte) error {
	msg := new(user_center.GoogleLoginRsp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *GoogleLoginResult) GetSuccess() *user_center.GoogleLoginRsp {
	if !p.IsSetSuccess() {
...
func (p *GoogleLoginResult) SetSuccess(x interface{}) {
	p.Success = x.(*user_center.GoogleLoginRsp)
}
...
func (p *kClient) GoogleLogin(ctx context.Context, Req *user_center.GoogleLoginReq) (r *user_center.GoogleLoginRsp, err error) {
